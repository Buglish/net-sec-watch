...
The OpenSearch storage ingestion gate requires at least 95% of accepted events to become
...
The result satisfies the OpenSearch storage completion gate. It should be rerun after
