# Machine-learning storage contracts

OpenSearch storage reserves OpenSearch storage structures for the Adaptive traffic intelligence security
...
auditable history of analyst decisions. The stream inherits the OpenSearch storage
...
records are registry entities queried by stable model ID and version. Adaptive traffic intelligence
