#!/usr/bin/env python3
"""Static machine-learning ML governance and shadow-mode contract checks."""
...
def test_baselines_frameworks_and_mlflow() -> None:
    ...
    assert_true(
        frameworks["scikit_learn"]["ml_status"] == "approved_candidate",
        "scikit-learn evaluation missing",
    )
    assert_true(frameworks["river"]["ml_status"] == "deferred", "River should be deferred")
    assert_true(frameworks["pytorch"]["ml_status"] == "deferred", "PyTorch should be deferred")
