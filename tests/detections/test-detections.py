#!/usr/bin/env python3
"""Static detection and alerting detection and alerting contract checks."""
...
def test_detection_runner_positive_and_negative() -> None:
    ...
    negative = subprocess.run(
        [
            ...
            "scripts/run-detections.py",
            "--events",
            "tests/detections/fixtures/detection-negative-events.jsonl",
            "--expect",
            "tests/detections/fixtures/detection-expected-negative-alerts.json",
        ],
        cwd=ROOT,
        check=True,
        capture_output=True,
...
def test_docs_and_feature_status() -> None:
    docs = [
        "docs/security-detections-alerting.md",
...
if __name__ == "__main__":
    for test in [
        ...
        test()
    print("Detection contract is valid.")
